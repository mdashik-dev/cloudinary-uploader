...
/** For action: 'replace' */
export interface ReplaceFileItem {
    /** New file to upload */
    file: File | Buffer | string
...
/** For action: 'getInfo' */
export interface GetInfoFileItem {
    publicId: string
    resourceType?: ResourceType
}
...
export interface GenerateUrlFileItem {
    publicId: string
    resourceType?: ResourceType
...
export type Action = keyof ActionFilesMap
...
export type UploaderInput<A extends Action = Action> = {
...
export class CloudinaryUploaderError extends Error {
    constructor(
